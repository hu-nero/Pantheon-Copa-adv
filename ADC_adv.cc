...
int AdaptiveAdvCC::flow_id_counter = 0;

double AdaptiveAdvCC::current_timestamp( void ){
  return cur_tick;
}

void AdaptiveAdvCC::init() {
  if (num_pkts_acked != 0) {
...
void AdaptiveAdvCC::update_theta()
{
...
void AdaptiveAdvCC::update_delta(bool pkt_lost __attribute((unused)), double cur_rtt) {
  double cur_time = current_timestamp();
...
double AdaptiveAdvCC::randomize_intersend(double intersend) {
...
void AdaptiveAdvCC::update_intersend_time() {
...
void AdaptiveAdvCC::onACK(int ack, 
...
void AdaptiveAdvCC::onPktSent(int seq_num) {
  double cur_time = current_timestamp();
...
void AdaptiveAdvCC::close() {
}

void AdaptiveAdvCC::onDupACK() {
  ///num_pkts_lost ++;
...
void AdaptiveAdvCC::interpret_config_str(string config) {
